...
\newcommand{\nachnameb}{Beck}              % Nachname des zweiten Praktikanten
\newcommand{\vornameb}{Janic}              % Vorname des zweiten Praktikanten

\newcommand{\emailadressea}{\href{mailto:useba@student.kit.edu}{useba[at]student.kit.edu}}
\newcommand{\emailadresseb}{}
% optionale Angabe von Emailadresse(n) für den Kontakt mit dem Betreuer

\newcommand{\versuch}{Hall-Effekt} % Name des Versuchs
...
\newcommand{\betreuer}{Julian Skolaut}                   % Name des zuständigen Betreuers
\newcommand{\durchgefuehrt}{1.02.20}              % Datum, an dem der Versuch
                                           % durchgeführt wurde
...
\begin{document}
    ...
    \input{00-include/titlepage} %\cleardoublepage
    \tableofcontents
    ...
    %\end{thebibliography}
    \Appendix
    \input{tab/probe_A.tex}
    \input{tab/probe_B.tex}
\end{document}
