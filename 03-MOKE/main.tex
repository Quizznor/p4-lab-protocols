...
\newcommand{\versuch}{MOKE} % Name des Versuchs
...
\newcommand{\betreuer}{Daria Gusenkova}                   % Name des zuständigen Betreuers
\newcommand{\durchgefuehrt}{14.12.2020}    % Datum, an dem der Versuch
                                           % durchgeführt wurde
